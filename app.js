  ...
  const PRODUCTS = [
    ...
    },
    {
      ...
      exams: [
        ...
        { code: "EX221", name: "Red Hat Certified Specialist in Cloud-native Integration (Retired)" },
        { code: "EX240", name: "Red Hat Certified Specialist in API Management (Retired)" },
